...
app.post("/search", (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=5685baac8db3c181cc7059fa48c80c3e&query=${userMovieTitle}`;
    let genresUrl = "https://api.themoviedb.org/3/genre/movie/list?api_key=5685baac8db3c181cc7059fa48c80c3e&language=en-US";
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=b91d25d8`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
